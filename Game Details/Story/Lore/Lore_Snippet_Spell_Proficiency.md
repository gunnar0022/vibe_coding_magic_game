...
The player sits wherever they've chosen to sit on the spectrum. A power-path player leans toward depth, drilling combat spells alongside the brother, becoming another fast caster in the party. A knowledge-path player leans toward breadth, building their own catalogue in parallel with the researcher, becoming a second problem-solver. The player's position determines the party's balance — and its blind spots.
...
*This snippet connects to: the kanji funnel system (casting as mental visualization), the knowledge economy (tomes as valuable and vulnerable objects), the brother's arc (combat proficiency as a product of obsessive focus), the researcher's role (breadth as both strength and fragility), the community and wandering paths (different tome profiles reflecting different lifestyles), and party composition across compass paths.*
